...
public class CrudAppTestSuite {
    public static final String BASE_URL = "https://krzysztofprzybyt.github.io/";
    ...
    private boolean checkTaskExistIntrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("krzysztof.przybyt@gmail.com");
        driverTrello.findElement(By.id("password")).sendKeys("Madzia2003");
        ...
        results = driverTrello.findElements(By.xpath("//span")).stream()
